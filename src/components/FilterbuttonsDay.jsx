...
export function FilterbuttonsDay({ schedule, onClick, selectedAct, selectedDay }) {
  ...
  return (
    <div className="mt-5 flex justify-center flex-wrap">
      <Button
        className={` leading-4 rounded-none font-sans font-bold border-2 border-solid place-self-center border-color-yellow h-10 w-12 hover:bg-color-yellow hover:text-color-black ${
