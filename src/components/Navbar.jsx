  ...
  return (
    <div className="z-60 flex justify-between bg-color-black-nav backdrop-blur p-3 sticky top-0 w-full z-50">
      ...
      <div className="flex justify-center">
        <Button className="font-bold rounded-none font-sans border-2 border-solid place-self-center border-color-yellow h-10 px-10 text-color-yellow hover:bg-color-yellow hover:text-color-black">BUY TICKETS</Button>
